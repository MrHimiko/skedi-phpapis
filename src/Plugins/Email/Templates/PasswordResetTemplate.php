...
class PasswordResetTemplate
{
    public static function render(array $data): string
    {
        ...
        $expiresIn = $data['expires_in'] ?? '1 hour';
                    ...
                    <tr>
                        <td style="padding: 40px 30px;">
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                <tr>
                                    <td align="center" style="padding: 20px 0;">
                                        <a href="{$resetUrl}" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: #ffffff; text-decoration: none; padding: 14px 30px; border-radius: 5px; font-size: 16px; font-weight: bold; display: inline-block;">
                                            Reset Password
                                        </a>
                                    </td>
                                </tr>
                            ...
                            <p style="color: #999999; font-size: 14px; line-height: 1.5; margin: 20px 0;">
                                This link will expire in {$expiresIn}. If you didn't request this reset, please ignore this email.
                            </p>
                            <div style="border-top: 1px solid #eeeeee; margin: 30px 0; padding-top: 20px;">
                                <p style="color: #999999; font-size: 12px; line-height: 1.5; margin: 0;">
                                    If the button doesn't work, copy and paste this link into your browser:
                                </p>
                                <p style="color: #667eea; font-size: 12px; line-height: 1.5; margin: 5px 0; word-break: break-all;">
                                    {$resetUrl}
                                </p>
                            </div>
                        </td>
